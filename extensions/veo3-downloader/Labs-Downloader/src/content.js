...
function findReferenceElement() {
    ...
    // Encontra o botão "Criação de cenas" para usar como referência de posicionamento
    const referenceButton = buttons.find(btn => btn.textContent.trim() === 'Criação de cenas');
